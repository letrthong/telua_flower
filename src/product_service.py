...
def create_or_update_product(
    ...
    if product_id:
        ...
        full_detail = {
            ...
            "dailyQuota": sum(int(v or 0) for v in stock_by_branch.values()) if stock_by_branch else int(product_data.get("dailyQuota") or old_detail.get("dailyQuota", 15)),
        ...
        full_detail = {
            ...
            "i18n": i18n_data if isinstance(i18n_data, dict) and i18n_data else None,
            "stockByBranch": stock_by_branch,
            "dailyQuota": sum(int(v or 0) for v in stock_by_branch.values()) if stock_by_branch else int(product_data.get("dailyQuota") or 15),
            "isActive": True,
            "createdAt": now_iso,
            "updatedAt": now_iso
        }
