...
class TestRBACDataProtection(unittest.TestCase):
    def setUp(self):
        ...
        _, _, self.admin_token, _ = authenticate_user("admin@nohoathabinh.vn", "123456")

        # 2. Đăng nhập Quản lý Chi Nhánh Q10
        _, _, self.manager_q10_token, _ = authenticate_user("0909123456", "123456")

        # 3. Đăng nhập Thợ cắm hoa Chi Nhánh Q10
        _, _, self.florist_q10_token, _ = authenticate_user("0908111222", "123456")
        ...
        _, _, self.cust_a_token, self.cust_a = authenticate_user(phone_a, "123456")
        ...
        _, _, self.cust_b_token, self.cust_b = authenticate_user(phone_b, "123456")
