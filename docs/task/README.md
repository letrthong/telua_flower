...
```text
Tiến độ tổng thể: [░░░░░░░░░░░░░░░░░░░░] 0% (0/8 Task hoàn thành)
```

| STT | Mã Task | Tên Phân Hệ & Mục Tiêu | Trạng Thái | File Đặc Tả Chi Tiết |
| :---: | :--- | :--- | :---: | :--- |
| **01** | `TASK_01` | **Khởi Tạo Cấu Trúc Dữ Liệu JSON & Storage Service** | 🔴 **TODO** | [TASK_01](file:///d:/code/telua_flower/docs/task/TASK_01_DATA_MODELS_AND_STORAGE.md) |
| **02** | `TASK_02` | **Hệ Thống Đăng Nhập Đơn Nhất & Phân Quyền JWT (5 Roles)** | 🔴 **TODO** | [TASK_02](file:///d:/code/telua_flower/docs/task/TASK_02_AUTH_AND_RBAC_SYSTEM.md) |
